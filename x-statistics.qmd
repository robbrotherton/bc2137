...
](figures/correlation.png){#fig-cor}
...
![Example of a bar graph showing average scores on the dependent variable for three groups of the independent variable. Note that, again, your graph would have more meaningful labels.](figures/bar.png){#fig-bar width="80%"}
...
ggplot(scatter_df, aes(X1, X2)) +
  geom_point() +
  xkcdaxis(c(1,5),c(1,5), ) +
  labs(x = "Variable X", y = "Variable Y") +
  theme(axis.text = element_text(family = "xkcd", size = 15),
        axis.title = element_text(family = "xkcd", size = 25))

ggsave(here::here("figures", "correlation.svg"), width = 3, height = 3)
```
...
ggsave(here::here("figures", "bar.svg"), width = 4, height = 3)
```
...
ggplot() +
  ...
  geom_point(data = anova_df, aes(x = IV1, y = DV, color = IV2), size = 1.5) +
  ...
  theme(axis.text = element_text(family = "xkcd", size = 15),
        ...
        axis.title = element_text(family = "xkcd", size = 25),
        legend.title = element_text(family = "xkcd", size = 25),
        legend.text = element_text(family = "xkcd", size = 15))

ggsave(here::here("figures", "anova.png"), width = 4, height = 3)
```
