...
schedule <- tibble::tribble(
  ...
  "3/10",  "Data preparation & analysis",
  "3/17",   "No class (Spring Break)",
  "3/24",  "Visualization & interpretation",
  "3/31",   "Presentations",
  
  # Project 3 header goes here
  "4/7",  "Project planning",
  "4/14",  "Data preparation",
  "4/21",  "Analysis",
  "4/28", "Presentations",
  "5/5", "Final paper submission"
)
...
Lab meeting: Monday 10:10-1PM, Milbank 410 

Instructor: Dr. Rob Brotherton (<rbrother@barnard.edu>)       
Office hour: Wednesday 1-2PM, Milbank 415M
