...
schedule <- tibble::tribble(
  ...
  "10/26",  "Data cleaning & analysis",  "",
  "11/2",   "Visualization & reporting", "Presentation slide",
  "11/9",   "Presentations",             "Project 2 report",
  
  # Project 3 header goes here
  "11/16",  "Project planning",          "",
  "11/23",  "No class (Thanksgiving)",   "",
  "11/30",  "Questionnaire design",      "Presentation slide",
  "12/7",   "Presentations",             "Project 3 report",
)
```
