# Lab 9: Finalizing Methods {.unnumbered}
...
This week you will finalize the details of your planned methodology, including collecting/producing all required materials, and creating Informed Consent  (see [Appendix @sec-consent]<span class="exclude-from-html">, p. \pageref{sec-consent}</span>) and Debriefing (see [Appendix @sec-debrief]<span class="exclude-from-html">, p. \pageref{sec-debrief}</span>) documents. We will consider methodological rigor and replicability, as well as what researchers are required to tell participants in the informed consent and debriefing documents, and why.


## Additional resources

[Link to slides with Method section examples](https://docs.google.com/presentation/d/1t3RqUh14893fCACWQY7OaYUvH7P0zzh4WIJB63gg1QY/edit?usp=sharing)


[Link to sample size calculator](https://www.statskingdom.com/sample_size_regression.html)
