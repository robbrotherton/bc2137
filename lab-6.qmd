...
The simplest example of this design is one in which the researcher randomly assigns participants to one of two groups, and then uses statistical techniques to look for differences between the groups (see [Appendix @sec-ttest]<span class="exclude-from-html">, p. \pageref{sec-ttest}</span>). 
