...
In this session we will begin the first project of the course: performing a correlational analysis using the ANES 2024 dataset. By the end of the session you will have a plan for your analysis.
...
readr::read_csv("data/anes_2024.csv") |> 
  select(threat_job = V241492, 
         threat_fin = V241539, 
         threat_health_ins = V241572, 
         threat_health_pay = V241573, 
         threat_going = V241123, 
         threat_terror = V242343,
         trust_gov = V241229, 
         trust_corrupt = V241233, 
...
- How worried do you feel about how things are going in the country? (`V241123`)
- So far as you and your family are concerned, how worried are you about your current financial situation? (`V241539`)
- How worried are you about losing your job in the near future? (`V241492`)
- How concerned are you about losing your health insurance in the next year? (`V241572`)
- How concerned are you about being able to pay health care expenses for you and your family in the next year? (`V241573`)
- How worried are you that the United States will experience a terrorist attack in the near future? (`V242343`)
...
To see exactly how these constructs were measured you will look up the variable IDs (the codes beginning with V in parentheses above) in the [Codebook](https://electionstudies.org/wp-content/uploads/2025/08/anes_timeseries_2024_questionnaire_20240808.pdf).
